...
# input artist/band name as command line argument
artist = sys.argv[1].lower().replace(' ', '')

print(artist)

artist_url = f'https://www.azlyrics.com/{artist[0]}/{artist}.html'

print(artist_url)

# check if valid azlyrics artist page URL
if requests.get(artist_url).status_code == 200:
...
# if input URL is not a valid AZLyrics artist page
    ...
    print('Please check the spelling of the artist/band name provided.\n')